...
map_the_meal_gap_df = map_the_meal_gap_df %>%
  mutate(year = str_extract(path, "_[0-9]{4}"),
         ...
         county_state = str_replace(county_state, "\\scounty",""),
         county_state = str_replace(county_state, "\\sparish",""),
         county_state = str_replace(county_state, "\\sborough", ""),
         county_state = str_replace(county_state, "\\scensus area", ""),
         county_state = str_replace(county_state, "\\smunicipality", ""),
         county_state = str_replace(county_state, "covington city", "covington"),
         county_state = str_replace(county_state, "do¤a ana", "doña ana"),
         county_state = str_replace(county_state, "du page", "dupage"),
