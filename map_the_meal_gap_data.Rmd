...
remote_driver$navigate("https://www.feedingamerica.org/find-your-local-foodbank")


driver <- remoteDriver(remoteServerAddr = "yourIP", port = 4445L) 
driver$open()
driver$navigate("https://www.feedingamerica.org/find-your-local-foodbank")
...
food_banks_html = read_html(url)

View(food_banks_html)
...
website_df = 
  tibble(
    name = name_vec,
    address_phone = address_phone_vec,
    website = website_vec)
```
