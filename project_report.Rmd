...
Food insecurity, the state of being without reliable access to a sufficient quantity of affordable, nutritious food, is a leading health and nutrition issue in the United States. In 2017 approximately forty million Americans were food insecure.
...
Existing research has shown food insecurity to disproportionately impact Black and Hispanic populations, as well as those with 

We are collectively interested in investigating the prevalence of food insecurity on the county-level and its association with select social determinants of health to understand the specific regions and/or subpopulations at the greatest risk for food insecurity. This information will help identify targets for future health policy implementation, which is of particular importance during/following the COVID-19 pandemic. 

Related work: Anything that inspired you, such as a paper, a website, or something we discussed in class.

Caroline: previous/ongoing work experience using ACS data to assess associations between demographic/social determinants and healthcare quality indicators (health policy economics research); personally impacted by FI


Find an article about food insecurity during covid

Initial questions: What questions are you trying to answer? How did these questions evolve over the course of the project? What new questions did you consider in the course of your analysis?

Our overarching question was, what does the food disparity across the United States look like on national, regional and county-levels? After investigating the variables in our datasets, we had access to a plethora of information that could help us answer more specific questions such as:
Which geographical areas are disproportionately affected?
Are affected individuals of predominantly one race, or do they reside in specific income brackets, for example?
And, can we visualize food insecurity and give people accessible information on how they can help? 
...
Caroline: 
Add to discussion
Line plot of NYC food insecurity by county overtime - put in project report, not dashboard
