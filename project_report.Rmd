...
There exists substantial regional variation in food insecurity and child food insecurity rates, and in the number of food insecure children and individuals across the United States. North Dakota, northern Virginia and Maryland contain counties with some of the lowest rates of food insecurity (less than 10 percent). Alabama and Mississippi, on the other hand, contain counties with over 35 percent overall food insecurity rates. 
...
Observational analysis of the scatterplot data suggests that there is a difference in food insecurity rates between races, levels of educational attainment, income brackets, and insurance statuses. 

There appears to be a positive association between percent Black race and food insecurity rate, and a negative association between percent White race and food insecurity rate on the county-level. White individuals populate the majority of virtually all counties, where increasing food insecurity rates are seen among counties in which the percentage of white individuals begins to drop. As the percentage of Black individuals increases within a county to above ~25%, food insecurity rates begin to increase. 

While a vast majority of US counties contain marginally small percentages of American Indian and/or Alaskan Native people, there appears to be a positive association between percent Native and food insecurity among the handful of counties with percentages between 15 and 75 percent. 

Among the educational attainment categories, there appears to be a negative association between bachelor's degree attainment and food insecurity rate. Conversely, the scatterplot shows a slight positive trend between 9-12th grade educational level and food insecurity rate. While no formal analysis was conducted, this finding is supported by the increased availability of higher paying jobs for college-educated individuals, and by the fact that college-educated individuals tend to have access to more financial resources than non-college-educated individuals. 

The insurance status plots suggest a positive association between percent uninsured people (ages 19-64) and food insecurity rate. Lastly, income brackets do show stark differences in distribution of individuals. As expected, higher proportions of upper quartile earners were associated with reduced county-level food insecurity rate.

## *Trends in national food insecurity rates*
