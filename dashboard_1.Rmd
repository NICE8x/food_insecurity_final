...
### Percent of Each Race Within Each County by Food Insecurity Rate
...
### Percent of Individuals in Levels of Education Attainment by Food Insecurity Rate
```{r, message = FALSE, warning = FALSE, echo = FALSE}
edu_per_plot =
...
### Percent of Individuals in Insurance Status Groups by Food Insecurity Rate
```{r, message = FALSE, warning = FALSE, echo = FALSE}
ins_status_plot =
...
### Percent of Individuals in Income Brackets by Food Insecurity Rate
```{r, message = FALSE, warning = FALSE, echo = FALSE}
income_brac_plot =
